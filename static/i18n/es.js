export default {
  GENERAL: {
    in_construction: 'PAGINA EN CONSTRUCCIÓN',
    in_construction_subtitle: 'Estamos construyendo la mejor experiencia para ti, por favor espere ;)',
  },
  TOOLBAR: {
  ...
  HOME: {
    card: {
      ...
      title_second: 'a tu',
      title_third: 'región!',
      text_first: 'ASOCIARSE',
      text_second:
        ' con el Centro del Programa de Jóvenes Exportadores de su región.',
    },
  },
  PARTNERS: {
    title: 'Socios',
  ...
  WHO: {
    card_member: {
      ...
      institutional_relations: 'Director de Relaciones Institucionales y Gubernamentales',
      content_director: 'Director de Contenido',
      technical_director: 'Director Técnico',
      ceo: 'Director Ejecutivo',
      administrative_financial_director: 'Director Administrativo y Financiero',
      legal_board: 'Junta Legal',
      cplp_Board: 'Junta CPLP',
      strategic_projects_board: 'Director de Proyectos Estratégicos y Asuntos Internacionales',
      executive_secretary: 'Secretaria Executiva'
    },
    general_board: 'JUNTA GENERAL',
  },
  ABOUT: {
