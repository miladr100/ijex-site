export default {
  GENERAL: {
    ...
    in_construction_subtitle: 'We are building the best experience for you, please wait ;)',
  },
  TOOLBAR: {
  ...
  HOME: {
    card: {
      ...
      title_third: 'region!',
      text_first: 'JOIN',
      text_second: ' to the Young Exporter Program Center in your region.',
    },
  },
  PARTNERS: {
    title: 'Partners',
  ...
  ABOUT: {
    card_member: {
      ...
      ceo: 'CEO',
      administrative_financial_director: 'Administrative and Financial Director',
